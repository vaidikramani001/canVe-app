...
export class DocumentCrudResolver {
  ...
  async aggregateDocument(
    ...
    @TypeGraphQL.Args() args: AggregateDocumentArgs,
  ...
  async createManyDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyDocumentArgs,
  ...
  async createOneDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneDocumentArgs,
  ): Promise<Document> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyDocumentArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneDocumentArgs,
  ...
  async findFirstDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstDocumentArgs,
  ): Promise<Document | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstDocumentOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstDocumentOrThrowArgs,
  ): Promise<Document | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async documents(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyDocumentArgs,
  ): Promise<Document[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async document(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueDocumentArgs,
  ): Promise<Document | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueDocumentOrThrowArgs,
  ): Promise<Document | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByDocumentArgs,
  ): Promise<DocumentGroupBy[]> {
  ...
  async updateManyDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyDocumentArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneDocumentArgs,
  ): Promise<Document | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneDocument(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneDocumentArgs,
  ): Promise<Document> {
    const { _count } = transformInfoIntoPrismaArgs(info);
