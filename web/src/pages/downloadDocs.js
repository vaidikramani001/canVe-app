            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', marginLeft: '350px', width: '70%' }}>
                ...
                <div style={{ flex: 1 }}>
                    ...
                    <div className="flex justify-between mt-8">
                        <div className="w-3/1 p-4 bg-gray-200 rounded-md ml-4">
                            {docs && docs.length > 0 ? (
                                <ul className="grid grid-cols-1 xl:grid-cols-3 gap-y-10 gap-x-6 items-start p-8">
                                    {docs.map((i) => {
                                        return (
                                            <li className="relative flex flex-col sm:flex-row xl:flex-col items-start rounded-lg overflow-hidden bg-white shadow-lg">
                                                <img
